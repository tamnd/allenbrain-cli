...
Most of these come down to network reality or how allenbrain serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

allenbrain rate-limits like any public site. allenbrain already paces
...
Where a surface is gated, allenbrain reads a cookie or token you supply
...
`allenbrain`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what allenbrain actually did
