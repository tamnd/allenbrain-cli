...
```
allenbrain <command> [arguments] [flags]
```

Run `allenbrain <command> --help` for the full flag list on any command. This
...
per operation you declare in `allenbrain/domain.go`.
